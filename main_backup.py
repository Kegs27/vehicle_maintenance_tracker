...
async def edit_oil_analysis_form(request: Request, record_id: int, return_url: Optional[str] = Query(None)):
    ...
    try:
        ...
        return templates.TemplateResponse("oil_analysis_form.html", {
            ...
            "return_url": return_url or "/oil-analysis"
        })
    except HTTPException:
        raise
    except Exception as e:
...
async def update_oil_analysis_route(
    ...
    try:
        ...
        if result["success"]:
            # Redirect to return_url if provided, otherwise to oil analysis page
            redirect_url = return_url or f"/oil-analysis/{vehicle_id}?updated=true"
